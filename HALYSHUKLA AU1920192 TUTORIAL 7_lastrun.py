...
expName = 'HALYSHUKLA AU1920192 TUTORIAL 7'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Haly\\Documents\\AU\\HALYSHUKLA AU1920192 TUTORIAL 7_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='report the delay between key press and beep sound(0-999); Click submit after entering the value.',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=2.0, method='random', 
    ...
    trialList=data.importConditions('TUTORIAL 7 CONDITIONS .xlsx'),
